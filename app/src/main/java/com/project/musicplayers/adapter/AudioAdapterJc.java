...
public class AudioAdapterJc extends RecyclerView.Adapter<AudioAdapterJc.AudioAdapterViewHolder> {
    private static final String TAG = AudioAdapterJc.class.getSimpleName();
    private static OnItemClickListener mListener;
    private List<JcAudio> jcAudioList;
    private SparseArray<Float> progressMap = new SparseArray<>();

    public AudioAdapterJc(List<JcAudio> jcAudioList) {
...
//        return audiosViewHolder;
    ...
    public void updateProgres(JcAudio jcAudio, float progress) {
